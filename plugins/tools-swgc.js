...
let handler = async (m, { conn, text }) => {
  ...
  if (/image/.test(mime)) {
    ...
    return conn.reply(m.chat, '✅ Estado subido correctamente, revisa la respuesta.', estado);
  }
    ...
    return conn.reply(m.chat, '✅ Estado de audio subido correctamente.', estado);
  }
    ...
    return conn.reply(m.chat, '✅ Estado de texto publicado correctamente.', estado);
  }
