...
handler.all = async function (m) {
  ...
  global.canalIdM = ["120363420590235387@newsletter"];
  global.canalNombreM = ["Ｉｓａｇｉ - Ｂｏｔ"];
  ...
  const senderNum = m.sender?.split('@')[0] || '0'
  global.fkontak = { key: { participants:"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${senderNum}:${senderNum}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
  global.rcanal = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: global.canalIdM, newsletterName: global.canalNombreM, serverMessageId: -1 }
  }}, { quoted: m }
}
